...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
  ### Relational DB's are databases that store their data in tables. SQL, or Structured Query Language, is a language that is used to manage databases and the data inside those databases.

- [ ] Why do tables need a `primary key`?
  ### It is the way we identify each entry in a database uniquely. This is usually an auto-incrementing integer.
- [ ] What is the name given to a table column that references the primary key on another table.
  ### a foreign key!
- [ ] What do we need in order to have a _many to many_ relationship between two tables.

  ### We need an intermediary table. This will hold the FK's that reference the PK on the related tables.
